...
def Stories():
    ...
    with tab1:
        ...
        st.write("Points southeast ,  🅰 tale to unfold . ")
        st.write("Look below , where pirates roam ,")
        st.write("How many good  👀 call it home ? ")
        add_vertical_space()
        st.write("A pirate awaits ,  🅰 daring sight , ")
        st.write("But how many  👀 shine with light ? ")
        st.write("Seek the answer , let curiosity guide , ")
